...
in
{
  ...
  globalEnableTest = makeUsersTest "global-enable" { hacknix.defaults.enable = true; };
  usersEnableTest = makeUsersTest "users-enable" { hacknix.defaults.users.enable = true; };
