...
let
  ...
  providerSpecificOptions = {
    ...
    keycloak = cfg: { keycloak = { inherit (cfg.keycloak) group; }; };

    oidc = cfg: { oidc = { issuer-url = cfg.oidc.issuerURL; }; };
  };
...
in {
  ...
  options.services.oauth2_proxy = {
    ...
    cookie = {
      ...
      sameSite = mkOption {
        type = types.nullOr (types.enum [ "none" "lax" "strict" ]);
        default = null;
        description = ''
  ...
  config = mkIf cfg.enable {
    ...
    hacknix.assertions.moduleHashes."services/security/oauth2_proxy.nix" =
      "7dbcc69b39e77f3d818cbf6f6d9625f5ebea87df86f6c0de82692886ed9195b9";
    hacknix.assertions.moduleHashes."services/security/oauth2_proxy_nginx.nix" =
      "eeba6449552ec1998f85cc532e4d366b7a0be1aa9857e259ec833ab7399ecb99";
